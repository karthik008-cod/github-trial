package javaInput;
import java.util.*;
public class LinearEquationsBasic7 {
    ...
    public static void main(String[] args) {
        ...
        for(int i=1;i<=n;i++){
            ...
            if (type == 1){
                System.out.println(i+". ("+coefficient2+symbol()+Power()+" + "+coefficient3+symbol()+Power()+")("+coefficient1+symbol()+Power()+" + "+coefficient4+symbol()+Power()+")");
            }else if (type == 2){
                System.out.println(i+". ("+coefficient2+symbol()+Power()+" - "+coefficient3+symbol()+Power()+")("+coefficient1+symbol()+Power()+" - "+coefficient4+symbol()+Power()+")");
            }else if (type == 3){
                System.out.println(i+". ("+coefficient2+symbol()+Power()+" + "+coefficient3+symbol()+Power()+")("+coefficient1+symbol()+Power()+" - "+coefficient4+symbol()+Power()+")");
